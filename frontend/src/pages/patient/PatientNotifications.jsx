    ...
    <div className="animate-fadeIn">
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p>Stay informed about your appointments, priority queue updates, and consultation alerts</p>
        </div>
        {notifications.some((n) => !n.readAt) && (
          <button className="btn btn-outline btn-sm" onClick={handleMarkAllRead}>
            <HiOutlineCheckCircle size={16} /> Mark All as Read
          </button>
        )}
      </div>
      ...
      {loading ? (
        ...
        <div className="card">
          <div className="empty-state">
            ...
            <p className="empty-state-text">No active notifications or alerts at this time.</p>
          </div>
        </div>
      ) : (
